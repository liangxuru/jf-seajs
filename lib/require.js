...
require.config({
    baseUrl: "/Mobile/forum/assets/",
    waitSeconds: 0,
    urlArgs: "v=201511301736",
    paths: {
        "jquery": "script/lib/jquery",
        "swiper": "script/lib/swiper.min",
        "common": "script/lib/common",
        "jweixin": "http://res.wx.qq.com/open/js/jweixin-1.0.0",
        "wxconfig": "script/lib/wxconfig",
        "auth": "script/lib/auth",
    ...
    shim: {
        ...
        //    exports: "layer"
        //},
        "index": ["css!style/lib/swiper.min.css", "css!style/index.css"],
        "postList": ["css!style/postList.css", "css!style/lib/swiper.min.css"],
        "post": ["css!style/post.css", "css!style/lib/swiper.min.css"]
    },
    config: {
        "auth": {
            debug: false,
            //openID: "o-d5PuNn0hGk64C7X0-zQDdm9EIU"
            openID: "oGWv4skf17nhY5bABKN5UI_5ZSbU"
        },
        "common": {
            prefix: ""
        }
